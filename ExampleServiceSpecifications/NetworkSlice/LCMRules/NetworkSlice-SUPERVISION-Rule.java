...
logtext(getServiceRefPropValue("3GPPP Network Slice @ ITAv (RFS)", "serviceCharacteristicValue", "spec.itav-netslice-enforcement.sliceManagerResponse.success"));
setCharValFromStringType("isConfigured", getServiceRefPropValue("3GPPP Network Slice @ ITAv (RFS)", "serviceCharacteristicValue", "spec.itav-netslice-enforcement.sliceManagerResponse.success"));
