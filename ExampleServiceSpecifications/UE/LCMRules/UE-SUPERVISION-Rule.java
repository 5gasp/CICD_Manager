...
logtext(getServiceRefPropValue("3GPPP UE @ ITAv (RFS)", "serviceCharacteristicValue", "spec.itav-ue-enforcement.sliceManagerResponse.success"));
setCharValFromStringType("isConfigured", getServiceRefPropValue("3GPPP UE @ ITAv (RFS)", "serviceCharacteristicValue", "spec.itav-ue-enforcement.sliceManagerResponse.success"));
