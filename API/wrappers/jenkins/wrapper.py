...
# @Last Modified time: 26-05-2022 10:23:24
# @Description: 
#!/usr/bin/env python3
# -*- coding: utf-8 -*-
#
...
class Jenkins_Wrapper:
    ...
    def create_jenkins_pipeline_script(self, executed_tests_info, developer_defined_tests_info, available_tests, descriptor_metrics_collection, metrics_collection_information, test_instance_id, testbed_id):
        jenkins_script_str = copy.copy(
            JenkinsConstants.JENKINS_BASE_PIPELINE_SCRIPT)
        pipeline_configuration = JenkinsPipelineConfiguration.Jenkins_Pipeline_Configuration(jenkins_script_str, executed_tests_info, developer_defined_tests_info, available_tests, descriptor_metrics_collection, metrics_collection_information, test_instance_id, testbed_id)
