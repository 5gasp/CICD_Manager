...
def load_config():
    ...
    try:
        ...
        Constants.METRICS_COLLECTION_INFO_FILEPATH = "static/metrics_collection_information.yaml" #config['DESCRIPTORS_LOCATION']['Metrics_Collection_Information_Descriptor_Filepath']
